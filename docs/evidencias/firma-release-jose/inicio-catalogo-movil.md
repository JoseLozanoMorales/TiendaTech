# Captura de inicio de TiendaTech en móvil

Archivo: [inicio-catalogo-movil.png](inicio-catalogo-movil.png).

Captura original aportada por José en esta conversación después de confirmar que el APK release se instala e inicia correctamente al resolver el conflicto con la firma debug anterior. Se conserva sin recortes ni modificaciones.
...
SHA-256 de la imagen original: `aba0db49ecbfee92cc80e3aa0e138771506b8c66929dd45b08ce6c2000127a2c`.

José autorizó incorporar esta captura y su nota al commit de E5, junto con la verificación de integridad de datos. Esta evidencia visual complementa la firma y la instalación previamente documentadas.
