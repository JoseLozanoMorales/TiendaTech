...
Las observaciones de evaluación E4 (GHCR), E6 (APK y checksum) y E8 (carpetas huérfanas) cuentan con los commits registrados en la tabla \ref{tab:cambios-entregas} y no constituyen pendientes documentales de esta tabla. Estos códigos de evaluación no designan entregas. Eval. E2 se retira de la tabla de deuda vigente: se corrió \texttt{GatewayIntegrationTest.todaFamiliaProtegidaRechazaSolicitudSinToken} sobre las 8 familias protegidas (11 pruebas, 0 fallos) y se versionó \path{docs/experimentos/resultados/iso25010/security-401-gatewayintegration-2026-09-11.csv}, que reemplaza al CSV ausente del 1 de septiembre citado por la matriz ISO. El cierre de E6 acredita un paquete debug y su integridad, no una instalación en dispositivo ni una firma de producción.
