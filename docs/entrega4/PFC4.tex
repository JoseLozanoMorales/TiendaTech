...
Mantenibilidad & Cobertura agregada 33{,}57\,\% sobre el árbol completo de los ocho servicios medidos (seis Java, el Gateway y \texttt{armado-ia}; 11{,}72--78{,}26\,\% por módulo; solo el Gateway alcanza el 70\,\%) y PMD máximo 9; cifra regenerada el 17 de septiembre de 2026 tras ampliar \texttt{armado-ia} a su paquete \texttt{app} completo y agregar JaCoCo al Gateway, ver §\ref{sec:cobertura-complejidad}.\\
...
La tabla \ref{tab:cobertura} procede del informe \path{informe-umbral-70.json}, regenerado el 17 de septiembre de 2026 sobre el árbol completo de cada servicio Java, el paquete \texttt{app} completo de \texttt{armado-ia} y el Gateway (\texttt{Apps/web/frontend}), que hasta entonces no tenía JaCoCo configurado. Las cifras resultantes son más bajas que las reportadas antes de ese ajuste, pero honestas: solo el Gateway alcanza el umbral del 70\,\%.
