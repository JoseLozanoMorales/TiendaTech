...
El resumen versionado de \href{https://github.com/JoseLozanoMorales/TiendaTech/blob/f6de7608d79b746d11a4c14440c89086d765b279/docs/experimentos/resultados/iso25010/complejidad/summary.csv}{complejidad} aplica el mismo criterio al servidor Java y al cliente TypeScript/React: máximo de complejidad ciclomática por método o función estrictamente inferior a diez. PMD mide Java y la regla \texttt{complexity} de ESLint mide la web en su variante clásica; cada herramienta cuenta las decisiones propias de su lenguaje. Los valores del backend corresponden a los XML conservados, no a una nueva ejecución local de PMD. Estos informes no respaldan la afirmación anterior de que los siete servicios cumplen. No se extiende esta medición al servicio Python.
...
\hline
Gateway & 7 & $<10$ & Cumple\\
Inventario & 20 & $<10$ & No cumple\\
Órdenes a proveedores & 16 & $<10$ & No cumple\\
Pedidos & 16 & $<10$ & No cumple\\
Productos & 8 & $<10$ & Cumple\\
Usuarios & 9 & $<10$ & Cumple\\
Ventas & 8 & $<10$ & Cumple\\
Cliente web & 26 & $<10$ & No cumple\\
\hline
\end{tabular}
\end{center}

La medición web analiza el código de producción de \texttt{src} (TypeScript y TSX), incluyendo componentes y callbacks; excluye pruebas y herramientas fuera de ese directorio. Se fuerza el umbral de reporte a cero para registrar todas las funciones, incluidas las de complejidad uno, sin permitir supresiones inline. La ejecución local del 13 de septiembre de 2026 registró 404 funciones y un máximo de 26 en la función \texttt{api}. Los valores, ubicaciones y versión de ESLint se conservan en \href{https://github.com/JoseLozanoMorales/TiendaTech/blob/f6de7608d79b746d11a4c14440c89086d765b279/docs/experimentos/resultados/iso25010/complejidad/webapp-complexity.json}{informe de complejidad web}. El comando \texttt{npm run complexity:report} actualiza la fila web del resumen conjunto y devuelve un código de error si el máximo alcanza diez. El job \texttt{web-quality} descarga la medición PMD de la misma ejecución de CI, añade la medición web y conserva ambas en el artefacto. Este control todavía falla con el código actual; medir con el mismo criterio no implica satisfacer el umbral y se requiere refactorizar las funciones que lo exceden.
